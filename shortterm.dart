...
class ShortTermGoalsPage extends StatefulWidget {
  ...
  const ShortTermGoalsPage({super.key});

  @override
  State<ShortTermGoalsPage> createState() => _ShortTermGoalsPageState();
}

class _ShortTermGoalsPageState extends State<ShortTermGoalsPage> {
